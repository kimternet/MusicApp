...
## 프로젝트 개요
본 프로젝트는 **Flutter 프레임워크**와 **FastAPI** 백엔드 기술을 활용하여 **음악 스트리밍 애플리케이션**을 구축하는 과정을 안내합니다**. MVVM (Model-View-ViewModel) 아키텍처를 기반으로 사용자 인증부터 백그라운드 음악 재생까지 다양한 기능을 구현했습니다.
